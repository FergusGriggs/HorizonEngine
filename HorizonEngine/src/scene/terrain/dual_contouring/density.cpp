...
namespace hrzn::scene::terrain
{
	...
	float Density_Func(const maths::Vec3f& worldPosition)
	{
		...
		const float cube = Cuboid(worldPosition, maths::Vec3f(-4.0f, 8.0f, -4.0f), maths::Vec3f(12.f));
		const float sphere = Sphere(worldPosition, maths::Vec3f(-25.0f, 8.0f, -4.0f), 16.0f);
		const float sphere2 = Sphere(worldPosition, maths::Vec3f(-25.0f, 8.0f, -20.0f), 8.0f);
		const float sphere3 = Sphere(worldPosition, maths::Vec3f(-25.0f, 8.0f, -32.5f), 4.0f);
		const float sphere4 = Sphere(worldPosition, maths::Vec3f(-25.0f, 8.0f, -40.0f), 2.0f);
		const float sphere5 = Cuboid(worldPosition, maths::Vec3f(-25.0f, 8.0f, -45.0f), maths::Vec3f(1.5f));

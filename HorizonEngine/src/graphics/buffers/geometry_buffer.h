...
namespace hrzn::gfx
{
	...
	public:
		...
		// Height -> DXGI_FORMAT_R16_UNORM
		// R -> Pixel height
		RenderTexture m_height;
		...
		ID3D11RenderTargetView*   m_renderTargetViews[5] = { nullptr };
		ID3D11ShaderResourceView* m_shaderResourceViews[5] = { nullptr };
	};
}